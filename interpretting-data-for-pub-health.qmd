...
A little bit about me, hi I'm Ana 👋
...
Data is interpreted in many ways, and can be interpreted through many phases of a project or study. Starting from the beginning such as the development of a research question, to the actual collection process itself, and through the means of eventually publishing these findings to inform other scientists and the greater public at large.
...
*we will also be talking a little bit of the data science process, as some knowledge of data science practices is needed when interpreting data.*
...
Prior to getting your hands on the data (or interpreting it) consider how the project/study was designed. A study design will usually define the following..
...
-   What did the interview/ data collection process look like
    ...
    -   What type of data (variables) are you collecting and why
        -   For ex: the ABCD protocol is a comprehensive set of physical, cognitive and social emotional, behavioral and academic assessments in addition to a neuroimaging and bio-specimen analysis done either annually or bi-annually for 10 year through the child's life.
...
::: {.column width="100%"}
![](images/Reproducibility-Spectrum.png){fig-align="center" width="614"}
:::

One way to ensure that your work is reproducible you should use code! 👩‍💻
...
-   With cod you are able to data exploring, cleaning data, visualizing data, model data and report your data in a manuscript all on the same document, such as using [Quarto.](https://quarto.org/)

## `Hello Quarto`

![](images/hello-quarto-positron.png){fig-align="center"}
...
-   Consider the programming language you will untilize
    ...
    -   Familiarize yourself with an IDE
        -   Integrated Development Environment (IDE), which is pretty much a software application that helps you do all the DS process.
            -   I like to use [RStudio](https://posit.co/download/rstudio-desktop/)

            -   or [Positron](https://positron.posit.co/)

            -   or VScode with the [Quarto extension](https://quarto.org/docs/get-started/hello/vscode.html)
...
-   this method ensures i keep rigorous documentation of every step i handle the data. this method also allows me to:
    ...
    -   maintain a tidy method of organization of files
    -   and R is also *free.*
...
::: {.column width="100%"}
![](images/hello-quarto-rstudio.png){fig-align="center" width="607"}
:::
...
::: {.column width="100%"}
![what can we say about the bidirectional relationship within these networks?](images/closeness.png)
:::
...
5.  Introdction to Statistical Learning <https://www.statlearning.com/>

6.  Reproducible Research with R, RStudio, and Github - Raymond Balise <https://vimeo.com/585821837>

7.  A Quart o' {rUM} (Using the {rUM} Package for Reproducible Medical Research (<https://www.youtube.com/watch?v=tiwx8mSUL1c&t=128s)>

8.  OpenIntro (<https://www.openintro.org/>)
